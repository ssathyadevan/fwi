...
TEST(FMContainerTest, TestDummy)
{
    ...
    //    GenericInput input = {caseFolder, inputFolder, outputLocation, runName, c_0, freq, reservoirTopLeftCornerInM, reservoirBottomRightCornerInM,
    //    sourcesTopLeftCornerInM, sourcesBottomRightCornerInM,
