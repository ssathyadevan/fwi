...
namespace inversionMethods
{
    ...
    private:
        ...
        /**
         * @brief calculateRegularisationErrorFunctional uses equation 2.21 from the thesis to calculate the error functional for regularisation and stores it
         * in regularisationPrevious
