...
public:
    finiteDifferenceForwardModel(
        const core::grid2D &grid, const core::sources &src, const core::receivers &recv, const core::frequenciesGroup &freq, const finiteDifferenceForwardModelInput &fmInput);
