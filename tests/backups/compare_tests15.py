...
print "************************************************************\n"
print "Increased overall precision:  " + str(increased_performance_test_passed)
print "Increased performance:        " + str(increased_precision_test_passed)
print_regression_test_passed_message(regression_test_passed)
#print "REGRESSION TEST PASSED:       " + (str(regression_test_passed)).upper()
