...
public:
    ...
    void updateVariables(const core::dataGrid2D &chiEstimateCurrent, const core::dataGrid2D &derivativeCurrent, int iteration, const std::vector<std::complex<double>> &,
