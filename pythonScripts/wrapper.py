...
run_fwi_cpp = subprocess.Popen('./FWI_PreProcess default', shell = True)              	# Run the preProcessing executable
run_fwi_cpp.wait()                                              					# Wait for that process to finish

run_fwi_cpp = subprocess.Popen('./FWI_Process default', shell = True)                       # Run the Processing executable
run_fwi_cpp.wait()                                                     					# Wait for that process to finish
