...
public:
    ...
    }   // the real KtimesResidual method cannot be applied without defining the whole core::complexDataGrid2D** _Kappa member, which defies the intent of creating a
        // mock class.
