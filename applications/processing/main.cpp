...
void performInversion(const genericInput& gInput, const integralForwardModelInput& fmInput, const conjugateGradientInversionInput& cgInput, const std::string &runName);
