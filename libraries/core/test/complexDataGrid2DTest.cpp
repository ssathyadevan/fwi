...
\
        ...
        TEST(dataGrid2DDoubleTest, sqrtTest)
        {
            ...
            double value = 36.0;
            complexDataGrid2D<double> dg(grid);
            dg = value;
        ...
        TEST(dataGrid2DDoubleTest, dotProductTest)
        {
            ...
            complexDataGrid2D<double> cdg(grid);
            cdg = testValue;
        ...
        // Operators
        TEST(dataGrid2DComplexTest, operatorAssignComplexDataGrid2DExceptionTest)
        {
            // Given
            grid2D grid = getGrid();
            complexDataGrid2D cdg(grid);
        ...
        TEST(dataGrid2DComplexTest, operatorAssignComplexDataGrid2DTest)
        {
            // Given
            grid2D grid = getGrid();
            const int nrOfGridPoints = grid.getNumberOfGridPoints();
        ...
        TEST(dataGrid2DComplexTest, operatorAddComplexDataGrid2DTest)
        {
            // Given
            grid2D grid = getGrid();
            const int nrOfGridPoints = grid.getNumberOfGridPoints();
        ...
        TEST(dataGrid2DComplexTest, operatorAddComplexDataGrid2DTest2)
        {
            // Given
            grid2D grid = getGrid();
            const int nrOfGridPoints = grid.getNumberOfGridPoints();
