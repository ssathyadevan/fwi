...
namespace fwi
{
    namespace forwardModels
    {
        ...
        TEST(helmholtz2dTest, CreateABCMatrixTest)
        {
            ...
            fmInput.boundaryConditionType = BoundaryConditionType::FirstOrderABC;
...
// This test is commented as there is a bug in SecondOrderABC implementation
...
//            fmInput.pmlWidthFactor = pmlWidthfactor;
//            fmInput.sourceParameter = sourceParameter;
//            fmInput.boundaryConditionType = BoundaryConditionType::SecondOrderABC;
