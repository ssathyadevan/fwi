...
namespace fwi
{
    namespace inversionMethods
    {
        ...
        class ConjugateGradientMPIInversion : public inversionInterface
        {
        private:
        ...
        public:
            ...
            ConjugateGradientMPIInversion(const ConjugateGradientMPIInversion &) = delete;
            ConjugateGradientMPIInversion &operator=(const ConjugateGradientMPIInversion &) = delete;
