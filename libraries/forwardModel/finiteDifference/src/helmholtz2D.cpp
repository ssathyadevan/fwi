    ...
    _b(), _oldgrid(grid), _newgrid(), _PMLwidth(), _freq(freq), _c0(c0), _waveVelocity(), _solver(), _srcInput(fmInput.sourceParameter)
{
    ...
    const std::array<double, 2> srcXmax =
        *max_element(src.xSrc.begin(), src.xSrc.end(), [](const std::array<double, 2> &lhs, const std::array<double, 2> &rhs) { return lhs[0] < rhs[0]; });
    const std::array<double, 2> srcXmin =
        *min_element(src.xSrc.begin(), src.xSrc.end(), [](const std::array<double, 2> &lhs, const std::array<double, 2> &rhs) { return lhs[0] < rhs[0]; });

    const std::array<double, 2> srcZmax =
        *max_element(src.xSrc.begin(), src.xSrc.end(), [](const std::array<double, 2> &lhs, const std::array<double, 2> &rhs) { return lhs[1] < rhs[1]; });
    const std::array<double, 2> srcZmin =
        *min_element(src.xSrc.begin(), src.xSrc.end(), [](const std::array<double, 2> &lhs, const std::array<double, 2> &rhs) { return lhs[1] < rhs[1]; });
...
void Helmholtz2D::CreatePMLMatrix(
    std::vector<Eigen::Triplet<std::complex<double>>> &triplets, std::array<int, 2> nx, double omega, std::array<double, 2> dx, std::array<double, 2> xMin)
{
