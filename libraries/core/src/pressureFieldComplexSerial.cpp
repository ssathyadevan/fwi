...
const std::complex<double> *PressureFieldComplexSerial::GetDataPtr() const { return _dataPointer; }

std::complex<double> *PressureFieldComplexSerial::GetDataPtr() { return _dataPointer; }
