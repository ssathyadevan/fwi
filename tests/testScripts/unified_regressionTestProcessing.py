...
if ((len(sys.argv) > 5) or (len(sys.argv) < 4)):
    print "please supply five or four arguments after python compare_tests.py\n\
...
elif (inversionmodel == "gradientDescentInversion" || inversionmodel == "OpenmpgradientDescentInversion")
