...
print("The mean value of chi (original image) is:             " +
      str(prfct_rsrvr_chi_array.mean()))
print("The square mean value of chi (original image) is:      " + str(square_mean))

print("\nAverage relative error (sqrt(sum_i^n(error_i^2)/sum_i^n(chi_i^2))):   " +
      str(float_formatter(numpy.sqrt(mse_new)/square_mean*100)) + "%\n")
